      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
        ...
        >
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=Rahmath+Community+Hall"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto flex items-center justify-center gap-2 w-full py-3 px-6 rounded-full border border-gold/50 text-sm font-medium hover:bg-gold hover:text-forest-night transition-colors"
            >
              <MapPin size={16} />
        ...
        >
          ...
          <div className="flex flex-col items-center w-full">
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=Yamuna+Wedding+Castle"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-auto flex items-center justify-center gap-2 w-full py-3 px-6 rounded-full border border-gold/50 text-sm font-medium hover:bg-gold hover:text-forest-night transition-colors"
            >
